---
title: "Pilotes et-matériel : Une grande histoire d'amour"
description: "Quand on dit drivers, on pense à ceux graphique. Mais ils ne sont pas seuls !"
...
et des périphériques autour, pour interagir avec le monde. Seules les façons de communiquer et le nombre de périphériques
...
Ces actions sont réalisées par des blocs matériels dédiés, et non le processeur même. Et, ces fameux périphériques ont besoin
...
Vous n'avez rien compris ? C'est… normal. Seul un œil averti est capable d'en comprendre les actions ! Pour cela, nous
...
exécuter pour que cela fonctionne ! Simple non ? Comment savoir quel programme utiliser si on ne connaît pas
...
:::note
Pour votre culture générale, `VEN_8086` est utilisé par Intel, en référence à son premier processeur, l'Intel... 8086 !
:::
...
même si plusieurs étaient branché ! C'est parce que, par défaut votre carte graphique ne comprend le langage que pour un. plus
tard, avec le driver chargé, les autres écrans se sont allumés.
:::
...
Si vous êtes arrivés jusque-là, vous vous demanderez sûrement pourquoi on voit régulièrement avec une catégorie de drivers spécifique : Les drivers graphiques.
