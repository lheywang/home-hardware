---
title: "Explorons nos GPUs"
description: "Une carte graphique, c'est quoi ?"
cover: "die.png"
---
...
Et maintenant, le plat de résistance, la pièce maîtresse : Le GPU. Ici, tout se passe rapidement, et
très ! Les débits de données atteignent par endroit le Tbps ! Pour donner un ordre d'idée :

Un réseau Ethernet très rapide, soit 130 Mo/s (~1 Gbps), et c'est déjà bien.
...
mauvais coup d'un enfant en maternelle, mais non ! Tout cela est PARFAITEMENT normal et maîtrisé !

Mais pourquoi ?

Les signaux ici sont très rapides (~4 GHz), et peuvent être perturbés par à peu près tout (y compris la
...
sont bien plus complexes, et ne seront pas détaillées ici.
...
mère, qui elle propose plusieurs bus, plusieurs ports, …).
