---
title: "C'est quoi un OS ?"
description: "Un OS, on en utilise tous plusieurs tout les jours, mais c'est quoi ?"
cover: "ce.png"
---
...
<Tabs>
    ...
    <TabItem label="multi-utilisateurs">
    ...
    <TabItem label="Protection de la mémoire">
        ...
        disparaître l'entièreté des erreurs de compatibilité logicielles d'autant. Tant que la mémoire est disponible en suffisamment
...
<Tabs>
    ...
    <TabItem label="MS-DOS / NT">
        ...
        au prix d'évolutions plus lentes et complexes (coucou explorer.exe, le processus qui gère LITTÉRALEMENT
    ...
    <TabItem label="Unix">
        ...
        certains pc portables, vendu avec FreeBSD pour économiser le coût d'une licence Windows.
...
![share](./server.png)
    ...
    <TabItem label="Embarqué">
        ...
        disparaître, quelle horreur). Si vous aviez accès à une interface graphique, ça ressemblerait à cela :
