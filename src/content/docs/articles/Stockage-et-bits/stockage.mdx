---
title: "Stockage et bits"
description: "Comment est-ce qu'un PC stocke de la donnée ?"
cover: "hddtime.jpg"
---
...
Depuis, nous avons augmenté la capacité d'un facteur 8 000 000, réduits la taille d'un facteur 56 000, ou réduit le prix
...
Tout est basé sur des transistors (eh oui, ces démons) de technologie MOS. Pour ici, pas besoin de tout savoir (ouf), 
...
Le nombre de bits est présenté sous la forme d'une appellation : xLC.
...
Un SSD, ça a plusieurs caractéristiques : La vitesse et la réactivité. Le premier est habituellement mis en avant, puisque
...
très gourmand en IOPS, mais peu en débit. Attention donc !
...
La plus proche, c'est 1024, soit $2^{10}$. Et c'est exactement de là que vient cet écart. (1 Go = 1000 Mo ; 1 Gio = 1024 Mo ...)

Windows, il affiche juste la capacité réelle en Kio, sous l'unité kB. Cela est parfaitement logique, mais notre cerveau
d'humain s'attend à une base 10 et non 2.
...
:::note
Ce comportement est propre à Windows, sur Linux, vous verriez bien la taille annoncée.
:::
...
En plus, il est petit (photo d'une carte MicroSD au-dessus) donc très intéressant pour une grosse densité de stockage !
