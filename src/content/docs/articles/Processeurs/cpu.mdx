---
title: "Processeurs : Comment marchent t-ils ?"
description: "Un processeur, le point central de notre PC. Mais il fonctionne comment ?"
cover: "core.jpg"
---
...
<p class="article-lead">
  **Un processeur, le point central de notre PC. Mais il fonctionne comment ?**
</p>
...
Plusieurs grands noms existent d'architecture, que vous avez pu croiser : ARM, x86, mais aussi d'autres (AVR, RISC V...).
...
Comme évoqué dans un article précédent (CF : [Airflow](/articles/refroidissement-airflow-et-tdp/airflow/)), un processeur, 
en lui-même, c'est nettement plus petit que le boîtier que vous avez en main. Si on zoome dessus (vraiment beaucoup), 
on peut apercevoir différentes zones :
...
## Les instructions, qu'est-ce que c'est ?
...
Je vous épargne le schéma électrique, certainement illisible. Je vous ai trouvé un petit dessin, chez nous amis de Wikipédia :
...
<Tabs>
    ...
    <TabItem label="Execution dans le désordre">
        ...
        réarrangement ! Gros gain de performance ici !
...
:::note
Votre processeur x86 tout neuf est parfaitement capable d'exécuter du code initialement conçu pour un processeur en 1976 !
À l'opposé, un processeur ARM récent (ARMv8a) n'est pas capable d'exécuter du code écrit en 2013 (ARMv7a)
:::
