---
title: "Alimentations et vrm"
description: "Un PC rapide c'est bien, un PC bien alimenté c'est mieux"
cover: "VRM.png"
---
...
d'une tension de 230 VAC. C'est beaucoup beaucoup trop pour votre PC !
...
\*Et cette tension de 12V tends de plus en plus à être insuffisante, les puissances en jeu
...
Le principe est de découper le 12V en entrée, pour en générer des impulsions assez peu larges
...
Il est nécessaire de noter que le coil whine n'est en aucun cas dangereux ni pour la bobine, 
...
été fait de manière plus rigoureuse, et intègre des bobines triées pour ne pas présenter
